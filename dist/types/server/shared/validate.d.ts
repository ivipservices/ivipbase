...
export declare const isValidNewUsername: (authRef: DataReference, username: string) => Promise<boolean>;
export declare const isValidUsername: (username: string) => boolean;
export declare const isValidDisplayName: (displayName: any) => boolean;
export declare const isValidPassword: (password: string) => boolean;
export declare const isValidPhotoURL: (photoURL: any) => boolean;
