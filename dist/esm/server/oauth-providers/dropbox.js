...
class DropboxAuthProvider extends oauth_provider_1.OAuth2Provider {
    ...
    async getAccessToken(params) {
        ...
        const response = await (0, simple_fetch_1.fetch)('https://api.dropbox.com/oauth2/token', {
            method: 'POST',
            headers: {
    ...
    async getUserInfo(access_token) {
        const response = await (0, simple_fetch_1.fetch)(`https://api.dropboxapi.com/2/users/get_current_account`, {
            method: 'POST',
            headers: {
