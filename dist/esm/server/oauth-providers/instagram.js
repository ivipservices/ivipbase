...
class InstagramAuthProvider extends oauth_provider_1.OAuth2Provider {
    ...
    async getAccessToken(params) {
        ...
        const response = await (0, simple_fetch_1.fetch)(`https://api.instagram.com/oauth/access_token`, {
            method: 'POST',
    ...
    async getUserInfo(access_token) {
        const response = await (0, simple_fetch_1.fetch)(`https://api.instagram.com/v1/users/self/?access_token=${access_token}`);
        const result = await response.json();
