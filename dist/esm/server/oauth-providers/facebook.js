...
class FacebookAuthProvider extends oauth_provider_1.OAuth2Provider {
    ...
    async getAccessToken(params) {
        ...
        const response = await (0, simple_fetch_1.fetch)(url);
    ...
    async getUserInfo(access_token) {
        ...
        const response = await (0, simple_fetch_1.fetch)(`https://graph.facebook.com/v7.0/me?fields=email,name,short_name,picture&access_token=${access_token}`);
        const result = await response.json();
