...
class SpotifyAuthProvider extends oauth_provider_1.OAuth2Provider {
    ...
    async getAccessToken(params) {
        ...
        const response = await (0, simple_fetch_1.fetch)('https://accounts.spotify.com/api/token', {
            method: 'POST',
            headers: {
    ...
    async getUserInfo(access_token) {
        const response = await (0, simple_fetch_1.fetch)('https://api.spotify.com/v1/me', {
            method: 'GET',
            headers: {
