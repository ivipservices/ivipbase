...
const oauth_provider_1 = require("./oauth-provider.js");
const simple_fetch_1 = require("../shared/simple-fetch.js");
class GoogleAuthProvider extends oauth_provider_1.OAuth2Provider {
    ...
    async getOpenIDConfig() {
        ...
        this._config = await (0, simple_fetch_1.fetch)(`https://accounts.google.com/.well-known/openid-configuration`).then(res => res.json());
        return this._config;
    }
    /**
    ...
    async getAccessToken(params) {
        ...
        const response = await (0, simple_fetch_1.fetch)(config.token_endpoint, {
            method: 'POST',
    ...
    async revokeAccess(access_token) {
        ...
        const response = await (0, simple_fetch_1.fetch)(`${config.revocation_endpoint}?token=${access_token}`);
    ...
    async getUserInfo(access_token) {
        ...
        const response = await (0, simple_fetch_1.fetch)(config.userinfo_endpoint, {
            method: 'GET',
