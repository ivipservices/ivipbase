...
const addRoute = (env) => {
    env.router.get(`/sync/mutations/${env.db.name}`, async (req, res) => {
        ...
        try {
            ...
            if (targets === null) {
                return (0, Errors_1.sendBadRequestError)(res, { code: "invalid_request", message: "Invalid mutations request" });
            }
            if (targets.length === 0) {
...
//# sourceMappingURL=sync-mutations.js.map