        ...
        env.db(dbName).ready(async () => {
            ...
            await env
                ...
                if (adminAccount === null) {
                    ...
                    const adminPassword = env.settings.auth.defaultAdminPassword || (0, password_1.generatePassword)();
                    ...
                    if (!adminAccount.password_salt) {
                        ...
                        passwordHash = (0, password_1.getOldPasswordHash)(env.settings.auth.defaultAdminPassword);
                    }
                    else {
