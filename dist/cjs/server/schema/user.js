...
const getPublicAccountDetails = (account) => {
    ...
    return {
        ...
        prevSignin: ((0, ivip_utils_1.isDate)(account.prev_signin) ? account.prev_signin : new Date(0)).toISOString(),
        prevSigninIp: (_d = account.prev_signin_ip) !== null && _d !== void 0 ? _d : "",
        lastSignin: ((0, ivip_utils_1.isDate)(account.last_signin) ? account.last_signin : new Date(0)).toISOString(),
        ...
        changePasswordRequested: ((0, ivip_utils_1.isDate)(account.change_password_requested) ? account.change_password_requested : new Date(0)).toISOString(),
        changePasswordBefore: ((0, ivip_utils_1.isDate)(account.change_password_before) ? account.change_password_before : new Date(0)).toISOString(),
