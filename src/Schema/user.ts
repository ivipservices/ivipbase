...
export const getPublicAccountDetails = (account: DbUserAccountDetails): User => {
	return {
		uid: account.uid,
		...
		prevSignin: account.prev_signin?.toISOString() ?? new Date().toISOString(),
		prevSigninIp: account.prev_signin_ip ?? new Date().toISOString(),
		lastSignin: account.last_signin?.toISOString() ?? new Date().toISOString(),
