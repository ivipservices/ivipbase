...
type PathRules = object & {
	[key: string]: PathRule | PathRule | string | object | any;
	// schema definitions
...
export type HasAccessResult = {
	...
	rulePath?: string;
	details?: Error;
} & ({ allow: true } | { allow: false; code: RuleValidationFailCode; message: string; rule?: PathRule; rulePath?: string; details?: Error });
