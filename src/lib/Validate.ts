...
export const isValidNewUsername = async (authRef: DataReference, username: any): Promise<boolean> => {
...
export const invalidSettingsError: ValidationError<"invalid_settings"> = {
	code: "invalid_settings",
	message:
		"Invalid settings, must be an object and contain only string, number and/or boolean values. Additionaly, string values can have a maximum length of 250, and a maximum of 100 settings can be added",
};
