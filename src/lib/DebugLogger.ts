...
export class DebugLogger {
	verbose: LoggingFunction = console.log.bind(console);
	log: LoggingFunction = console.log.bind(console);
	warn: LoggingFunction = console.warn.bind(console);
	error: LoggingFunction = console.error.bind(console);
	write: (text: string) => void = console.log.bind(console);
